...
const todasLasPreguntas = [
  ...
  {
    letra: "C",
    pregunta: "¿Cómo se llama el continente donde está Egipto?",
    respuesta: "africa",
  },
  {
    letra: "D",
    pregunta: "¿Qué gas es fundamental para la respiración humana?",
    respuesta: "dioxido de carbono",
  },
  {
    letra: "E",
    pregunta: "¿Cuál es el órgano encargado de bombear sangre en el cuerpo?",
    respuesta: "corazon",
  },
  {
    letra: "F",
    pregunta: "¿Qué objeto se usa para volar en el cielo con viento?",
    respuesta: "cometa",
  },
  {
    letra: "G",
    pregunta: "¿Qué instrumento musical tiene cuerdas y se toca con las manos?",
    respuesta: "guitarra",
  },
  {
    letra: "H",
    pregunta: "¿Qué gas es el más abundante en el universo?",
    respuesta: "hidrogeno",
  },
  {
    letra: "I",
    pregunta: "¿Qué país tiene como capital a Islamabad?",
    respuesta: "pakistan",
  },
  {
    letra: "J",
    pregunta:
      "¿Qué fruta tropical es de color amarillo y tiene cáscara gruesa?",
    respuesta: "banana",
  },
  {
    letra: "K",
    pregunta: "¿Cuál es un arte marcial de origen japonés?",
    respuesta: "karate",
  },
  {
    letra: "L",
    pregunta: "¿Qué mamífero marino es conocido por cantar bajo el agua?",
    respuesta: "ballena",
  },
  {
    letra: "M",
    pregunta: "¿Qué astro es el satélite natural de la Tierra?",
    respuesta: "luna",
  },
  {
    letra: "N",
  ...
  {
    letra: "Ñ",
    pregunta: "Contiene la letra Ñ, ¿cómo se llama el río más largo de España?",
    respuesta: "tajo",
  },
  {
    letra: "O",
    pregunta:
      "¿Qué fruta es redonda, de color anaranjado y rica en vitamina C?",
    respuesta: "naranja",
  },
  {
    letra: "P",
    pregunta: "¿Qué metal precioso es conocido por su color dorado?",
    respuesta: "oro",
  },
  {
    letra: "Q",
    pregunta: "¿Qué capital de Ecuador empieza con la letra Q?",
    respuesta: "quito",
  },
  {
    letra: "R",
    pregunta: "¿Qué animal es conocido por su rapidez y manchas en la piel?",
    respuesta: "guepardo",
  },
  {
    letra: "S",
    pregunta: "¿Qué líquido se usa para cocinar y proviene del mar?",
    respuesta: "sal",
  },
  {
    letra: "T",
    pregunta: "¿Qué planeta del sistema solar es el más grande?",
    respuesta: "jupiter",
  },
  {
    letra: "U",
    pregunta: "¿Qué país sudamericano tiene a Montevideo como capital?",
    respuesta: "uruguay",
  },
  {
    letra: "V",
    pregunta: "¿Qué líquido rojo transporta oxígeno en el cuerpo humano?",
    respuesta: "sangre",
  },
  {
    letra: "W",
    pregunta: "¿Qué ciudad de Estados Unidos es la capital del país?",
    respuesta: "washington d.c.",
  },
  {
    letra: "X",
    pregunta:
      "Contiene la letra X, ¿qué instrumento musical de percusión tiene placas metálicas?",
    respuesta: "xilofono",
  },
  {
    letra: "Y",
    pregunta: "¿Qué país de Asia tiene su nombre con la letra Y?",
    respuesta: "yemen",
  },
  {
    letra: "Z",
    pregunta: "¿Qué mamífero con rayas blancas y negras vive en África?",
    respuesta: "cebra",
  },
];
...
function PasaPalabraPage() {
  ...
  const enviarRespuesta = () => {
    if (
      ...
      preguntas[indiceActual].respuesta.toLowerCase()
    ) {
